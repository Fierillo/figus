...
const T = {
  es: {
    ...
    market_transfers:  "Transferencias confirmadas",
    market_i_have_it:  "la tengo",
    market_filter_all:     "Todas",
    market_filter_missing: "No la tengo",
    ...
    pm_challenges_active: "EN CURSO",
    pm_challenges_finished: "TERMINADOS",
    ...
    landing_game_desc: "Jugá penales en la cancha 3D con WebGL. Si convertís, ganás un sobre. Desafiá amigos: si ganás la tanda, le robás una figurita de su álbum.",
    landing_steal_title: "ROBO DE FIGURITAS",
    landing_steal_desc: "Desafiá a otro coleccionista a una tanda de penales. El ganador le roba una figurita aleatoria al perdedor. El resultado queda grabado en Nostr.",
    landing_bets_title: "APUESTAS EN SATS",
    landing_bets_desc: "Apostá sats en el resultado de cada partido (gana local / empate / gana visitante). Alguien acepta tu apuesta — el issuer paga automáticamente al ganador cuando termina el partido.",
    landing_prizes_label: "PREMIOS REALES EN SATS",
    landing_prizes_team: "Completás un equipo",
    landing_prizes_team_sats: "⚡ 210 sats",
    landing_prizes_album: "Completás el álbum",
    landing_prizes_album_sats: "⚡ 5.000 sats",
    landing_prizes_note: "Pagados automáticamente vía Lightning. Sin trámites.",
  ...
  en: {
    ...
    market_transfers:  "Confirmed transfers",
    market_i_have_it:  "I have it",
    market_filter_all:     "All",
    market_filter_missing: "Don't have it",
    ...
    pm_challenges_active: "IN PROGRESS",
    pm_challenges_finished: "FINISHED",
    ...
    landing_game_desc: "Play penalties on a 3D WebGL pitch. Score and win a pack. Challenge friends: if you win the shootout, you steal a sticker from their album.",
    landing_steal_title: "STICKER STEALING",
    landing_steal_desc: "Challenge another collector to a penalty shootout. The winner steals a random sticker from the loser's album. The result is recorded on Nostr.",
    landing_bets_title: "BET IN SATS",
    landing_bets_desc: "Bet sats on any match result (home / draw / away). Someone accepts your bet — the issuer automatically pays the winner when the match ends.",
    landing_prizes_label: "REAL PRIZES IN SATS",
    landing_prizes_team: "Complete a team page",
    landing_prizes_team_sats: "⚡ 210 sats",
    landing_prizes_album: "Complete the full album",
    landing_prizes_album_sats: "⚡ 5,000 sats",
    landing_prizes_note: "Paid automatically via Lightning. No claims needed.",
